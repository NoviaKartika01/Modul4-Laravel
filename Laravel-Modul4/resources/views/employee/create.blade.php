...
{{--
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            {{-- @error('age') is-invalid @enderror digunakan untuk menunjukkan terjadi kesalahan dan penanda pada inputan tyang tidak valid --}}
                            <input type="text" class="form-control @error('lastName') is-invalid @enderror" name="lastName" id="lastName" value="{{ old('lastName') }}" placeholder="Enter Last Name">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            {{-- input data Age --}}
                            {{-- @error('age') is-invalid @enderror digunakan untuk menunjukkan terjadi kesalahan dan penanda pada inputan tyang tidak valid --}}
                            <input type="text" class="form-control @error('age') is-invalid @enderror" name="age" id="age" value="{{ old('age') }}" placeholder="Enter Age">
